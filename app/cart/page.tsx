...
export default function CartPage() {
  ...
  const shipping: number = cartItems.length > 0 ? 0 : 0; // Free shipping for VOX
        ...
        {cartItems.length === 0 ? (
          <div className="text-center py-20 border-2 border-dashed border-gray-200 rounded-2xl">
            ...
            <p className="text-gray-500 mb-8">
              Discover our curated selection of beauty products and start
              shopping.
            </p>
            <Link
              href="/beauty"
              ...
              {cartItems.map((item, index) => (
                <div
                  ...
                  className={`flex gap-6 pb-8 border-b ${
                    showDarkMode ? "border-gray-800" : "border-gray-100"
                  } group`}
                >
                  ...
                  <div className="flex-grow">
                    <div className="flex justify-between items-start mb-2">
                      <div>
                        <div className="text-[10px] font-bold text-vox-red uppercase tracking-widest mb-1">
                          {item.brand}
                        </div>
